...
function Header() {
    ...
    return (
        <nav className="navbar navbar-expand-lg navbar-dark bg-dark fixed-top py-0 border border-secondary border-2">
            <div className="container my-1">
                ...
                <div className="collapse navbar-collapse fw-bolder" id="navbarResponsive">
